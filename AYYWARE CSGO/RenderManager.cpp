...
void Render::Initialise()
{
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuBold, "Verdana", 12, 400, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::ESP, "arial", 11, 700, 0, 0, FONTFLAG_NONE);
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::Tabs, "eagle", 30, 600, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::LBY, "Verdana", 37, 900, 0, 0, FONTFLAG_ANTIALIAS);
