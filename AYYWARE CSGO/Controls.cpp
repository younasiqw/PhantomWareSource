...
void CCheckBox::Draw(bool hover)
{
	...
	if (Checked)
	{
		Render::Text(a.x + 1, a.y - 1, Color(0, 204, 204, 255), Render::Fonts::MenuSymbols, L"✔");
		Render::Outline(a.x, a.y, 14, 14, Color(2, 2, 2, 255));
	}
}
...
void CSlider::Draw(bool hover)
{
	...
	Render::GradientV(a.x, a.y, Location, 7, Color(0, 204, 204, 255), Color(20, 20, 20, 245));
	...
	Render::Text(a.x + Location - txtSize.right / 2, a.y + 5, Color(200, 200, 200, 255), Render::Fonts::MenuBold, buffer);
}
...
void CButton::Draw(bool hover)
{
	...
	Render::Outline(a.x, a.y, m_iWidth, m_iHeight, Color(2, 2, 2, 255));
	if (hover)
		Render::Clear(a.x + 2, a.y + 2, m_iWidth - 4, m_iHeight - 4, Color(40, 40, 40, 255));
	else
		Render::Clear(a.x + 2, a.y + 2, m_iWidth - 4, m_iHeight - 4, Color(35, 35, 35, 255));
...
void CComboBox::Draw(bool hover)
{
	...
	{
		// The current item
		Render::Text(a.x + 5, a.y + 2, Color(0, 204, 204, 255), Render::Fonts::MenuBold, GetItem().c_str());
		...
		if (IsOpen)
		{
			...
			for (int i = 0; i < Items.size(); i++)
			{
				...
				{
					Render::Text(a.x + 5, a.y + 19 + i * 16, Color(0, 204, 204, 255), Render::Fonts::MenuBold, Items[i].c_str());
				}
				else
				{
...
void CTextField2::Draw(bool hover)
{
	...
	Render::Clear(a.x, a.y, m_iWidth, m_iHeight, Color(30, 30, 30, 255));
	if (hover || IsGettingKey)
		Render::Clear(a.x + 2, a.y + 2, m_iWidth - 4, m_iHeight - 4, Color(35, 35, 35, 255));
